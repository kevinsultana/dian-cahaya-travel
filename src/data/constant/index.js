export const initialPaketWisata = [
  {
    id: "pw-001",
    ...
    terpakai: 32,
    featured: true,
    deskripsi: "Ibadah iktikaf khusyuk di 10 malam terakhir Ramadhan dengan akomodasi hotel bintang 5.",
    gambar: "https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?w=600&q=80",
    badge: "Ramadhan",
    category: "Reguler",
  ...
  },
  {
    ...
    terpakai: 18,
    featured: true,
    deskripsi: "Nikmati keindahan sejarah Islam di Istanbul sebelum melaksanakan ibadah Umroh dengan pelayanan eksklusif.",
    gambar: "https://images.unsplash.com/photo-1564769625722-2e6b6f3ec53a?w=800&q=80",
    badge: "Best Seller",
    category: "Plus Turki",
  ...
  },
  {
    ...
    terpakai: 25,
    featured: true,
    deskripsi: "Paket hemat Maulid Nabi dengan akomodasi nyaman dekat dengan pelataran masjid.",
  ...
  },
  {
    ...
    durasi: "25 Hari",
    harga: 285000000, // Rp 285.000.000 (equivalent to USD 18.500)
    ...
    terpakai: 5,
    featured: false,
    deskripsi: "Ibadah Haji tanpa antre panjang resmi dengan visa Furoda dan fasilitas tenda maktab VIP.",
    gambar: "https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?w=600&q=80",
    badge: "Haji VIP",
  ...
  },
  {
    ...
    terpakai: 12,
    featured: false,
    deskripsi: "Perjalanan ibadah Umroh reguler selama 12 hari menggunakan maskapai Garuda Indonesia.",
    gambar: "https://images.unsplash.com/photo-1564769625722-2e6b6f3ec53a?w=600&q=80",
    badge: "",
    category: "Reguler",
  ...
  },
  {
    ...
    terpakai: 8,
    featured: false,
    deskripsi: "Ziarah ke Masjidil Aqsa di Palestina serta situs bersejarah di Petra Yordania sebelum beribadah Umroh.",
    gambar: "https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=600&q=80",
    badge: "Ziarah",
    category: "Plus",
...
export const initialTestimoni = [
  {
    id: "tm-001",
    nama: "Bpk. Slamet",
    foto: "",
    bintang: 5,
    teks_deskripsi: "Pelayanan sangat luar biasa. Pembimbingnya sangat sabar dan detail menjelaskan setiap rukun umroh. Hotelnya pun sangat dekat dengan Masjidil Haram.",
  },
  {
    id: "tm-002",
    nama: "Ibu Aminah",
    foto: "",
    bintang: 5,
    teks_deskripsi: "Program Plus Turki-nya sangat berkesan. Manajemen waktunya rapi, kami tidak merasa lelah meski jadwalnya padat. Terima kasih Dian Cahaya Travel!",
  },
  {
    id: "tm-003",
    nama: "H. Ridwan",
    foto: "",
    bintang: 4,
    teks_deskripsi: "Saya baru pertama kali umroh dan merasa sangat terbantu dengan bimbingan manasik yang komprehensif. Semuanya diurus dengan sangat profesional.",
  },
];

export const initialBannerPromo = [
  {
    id: "bp-001",
    judul: "Promo Spesial Ramadhan",
    subjudul: "Dapatkan diskon hingga 15% untuk paket umroh ramadhan 2025",
    gambar: "https://lh3.googleusercontent.com/aida-public/AB6AXuAlP_OqLL0yI2K8SD3y5KRjcZ_WoX5mUIvnNdEzUAtIgW1U6sPM9wpoMqrHxV2YwK22f8_-hxECdjWHq9BqiuEebx6pAqSRYKdaapZLvue_n_G9wuSbb-26XmP-h5IfBNISSMcPNsfg9FEZMcVlFeuQLLVByrKk4gRDeM6UzFnHvV4_QVizLNdMrX70UBqdpJVt6wupg-xVaH6Wd8liqaIq8r68Oc4dn5eQjobbWI2bdGF9s28FZUcWvxm7YraAeLgMRHNzO4Ep-If-",
    tautan: "/paket-umrah",
    status: "aktif",
  },
];

export const initialPengaturanWa = {
  nomor: "6281234567890",
  pesan_template: "Assalamualaikum Dian Cahaya Travel, saya tertarik dengan paket umroh yang ditawarkan. Mohon informasi lebih lanjut.",
};

export const initialInquiryJemaah = [
  {
    id: "iq-001",
    nama: "Ahmad Fauzi",
    wa: "6281234567890",
...
export const initialTentangKami = {
  judul: "Tentang Dian Cahaya Travel",
  subjudul: "Biro Umroh dan Haji Terpercaya Sejak 2015",
  deskripsi: "Dian Cahaya Travel adalah biro perjalanan ibadah yang berkomitmen memberikan pelayanan terbaik untuk setiap jamaah. Dengan pengalaman lebih dari 10 tahun, kami telah membantu ribuan jamaah mewujudkan impian ibadah ke Tanah Suci.",
  visi: "Menjadi biro perjalanan ibadah terdepan yang memberikan pengalaman ibadah yang nyaman, aman, dan berkesan bagi setiap jamaah.",
  misi: "Menyediakan paket perjalanan ibadah yang terjangkau dengan pelayanan profesional dan fasilitas premium, serta pembimbing yang berpengalaman dan ramah.",
...
export const negaraOptions = [
  { id: "+62", nama: "Indonesia (+62)" },
  { id: "+60", nama: "Malaysia (+60)" },
  { id: "+65", nama: "Singapura (+65)" },
  { id: "+971", nama: "UAE (+971)" },
  { id: "+966", nama: "Arab Saudi (+966)" },
  { id: "+44", nama: "Inggris (+44)" },
];
...
export const initialHeroSection = [
  {
    ...
    subjudul: "Wujudkan impian ibadah Umroh dan Haji Anda bersama pembimbing profesional dan fasilitas premium bintang 5 yang telah terverifikasi resmi oleh Kemenag.",
    gambar: "https://lh3.googleusercontent.com/aida-public/AB6AXuDtaYWOB21a2Y9_BUEI1VmUDFJbZgYQOhrUbqR9PvTfE2vVRbRkl8uu-5TNUFXzutSqixF65tFePdChYBf9WCUuM95tSXRGcmhhQsQ-HSkXMPw2uBp8R_xmPNagC2UndJXU9OS-ySThVynVUmmjRtcfE2y8UN03B_3WyaNX5dOZMqN4F7DdNj_tBCtU31rI780t2c3TSxXO1U25943c-OuIQQs6kmiBICkIrkOLHbVDISeFPU9aKlxE2tjJXdSq0H8Pm43_PAEiW0H0",
